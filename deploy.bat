...
REM set path
set project_name=pitaya-demo
set backup_path=E:\backup\pitaya-demo
set project_path=E:\workspace\pitaya-demo
set publish_path=D:\project\webPublish\pitaya-demo
set static_publish_path=D:\project\staticPublish\pitaya-demo\static
